...
bash rime-install iDvel/rime-ice:others/recipes/config:schema=double_pinyin_sogou
...
bash rime-install iDvel/rime-ice:others/recipes/grammar:schema=double_pinyin_sogou
...
bash rime-install iDvel/rime-ice:others/recipes/reverse_tone:schema=double_pinyin_sogou
